class Modal {
	constructor(options) {
		...
		this.modal = document.querySelector('.gallary-modal');
		this.speed = false;
	...
	events() {
		if (this.modal) {
			...
			this.modal.addEventListener('click', function(e) {
				if (!e.target.classList.contains('gallary-modal__container') && !e.target.closest('.gallary-modal__container') && this.isOpen) {
					this.close();
				}
			}.bind(this));
		}
